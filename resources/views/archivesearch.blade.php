<x-app-layout>
    <div class='container'>
        <div class="row">
        <div class="col-8">
            <table class="table table-striped ml-20 mt-5" style="width: 100%;height:fit-content;border-color:black;border:2px solid;padding:10px;">
       ...
       <div class="col-4">
            <table class="table  ml-20 mt-5" style="width: 60%;height:fit-content;border-color:black;border:2px solid;padding:10px;">
                <thead class="thead-dark">
                    <tr >
